...
inputs = {
  sufix        = ""
  network      = dependency.as.outputs.network
  subnetwork   = dependency..outputs.subnetwork
  private_tag  = "private"
  ...
  cluster_secondary_range_name        = dependency..outputs.seconday_pods_name
  service_secondary_range_name        = dependency..outputs.seconday_services_name
  labels = {
    private-pools = "true"
  }
  #Additional nodepool
